...
private:
    vector<unsigned int> path; // Ancestor of node i (which can be itself). It is used to determine if two nodes are part of the same set.
    vector<unsigned int> rank; // Upper bound for the height of a tree whose root is node i.
};
